            ...
            <div class="row">
                <div class="col-md-4 col-sm-4 col-xs-12">
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            <br />
                            <form id="demo-form" action="{{ url('/admin/categories') }}" data-parsley-validate method="post">
                                {{ csrf_field() }}
                ...
                <div class="col-md-8 col-sm-8 col-xs-12">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2>All<small>catrgories</small></h2>
                            <ul class="nav navbar-right panel_toolbox">
                                <li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a> </li>
                                <li><a class="close-link"><i class="fa fa-close"></i></a> </li>
                            </ul>
                                    ...
                                    <tbody>
                                        @foreach ($categories as $category)
                                            <tr>
                                                ...
                                                <td>
                                                    <div>
                                                        <a href="{{ url('/admin/categories/'.$category->id . '/edit') }}"  style="color: #00CC99;">
                                                            <i class="fa fa-edit m-right-xs"></i><b>Edit</b>
                                                        </a> | 
                                                        <a data-toggle="modal" data-target=".category_form_delete_{{ $category->id }}" href=""  style="color: red;">
                                                            <i class="fa fa-btn fa-trash"></i> <b> Delete </b>
                                                        </a>
                                                    </div>
                                                    <div class="modal fade category_form_delete_{{ $category->id }}" tabindex="-1" role="dialog" aria-hidden="true">
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                    <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">×</span> </button>
                                                                    <h4 class="modal-title" id="myModalLabel">Delete Category</h4> </div>
